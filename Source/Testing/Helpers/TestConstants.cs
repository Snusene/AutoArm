...
namespace AutoArm.Testing.Helpers
{
    ...
    public static class TestConstants
    {
        ...
        public const float SearchRadiusClose = 15f;

        public const float SearchRadiusMedium = 30f;
        public const float DefaultSearchRadius = 60f;
        public const float RaidApproachDistance = 80f;
        ...
        public const double AcceptableCacheRebuildTime = 100.0;

        public const double MaxCacheRebuildTime = 500.0;

        public const double AcceptableWeaponSearchTime = 5.0;

        public const double MaxWeaponSearchTime = 20.0;
    ...
    public static class TestPositions
    {
        ...
        public static Dictionary<float, List<IntVec3>> GetProgressiveDistancePositions(IntVec3 center, Map map)
        {
            ...
            float[] distances = {
                TestConstants.SearchRadiusClose,
                TestConstants.SearchRadiusMedium,
                TestConstants.DefaultSearchRadius,
                TestConstants.RaidApproachDistance
            };
