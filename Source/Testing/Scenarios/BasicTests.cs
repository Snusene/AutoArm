        ...
        public TestResult Run()
        {
            ...
            else
            {
                ...
                else if (testWeapon != null)
                {
                    ...
                    AutoArmLogger.Error($"[TEST] UnarmedPawnTest: Available weapon {testWeapon.Label} - passesValidation: {passesValidation}, score: {score}");
                    reason = passesValidation ? "Valid but not chosen" : "Failed validation (enable debug logging for details)";
                }
            }
    ...
    public class WeaponUpgradeTest : ITestScenario
    {
        ...
        public TestResult Run()
        {
            ...
            if (job == null)
            {
                ...
                else if (!passesValidation) failureReason = "Weapon failed validation (enable debug logging for details)";
