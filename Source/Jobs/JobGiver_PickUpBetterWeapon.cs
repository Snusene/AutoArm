...
namespace AutoArm.Jobs
{
    ...
    public class JobGiver_PickUpBetterWeapon : ThinkNode_JobGiver
    {
        ...
        /// <param name="mapComp">Optional pre-cached map component to avoid repeated GetComponent calls in hot path</param>
        public bool ShouldConsiderWeapon(Pawn pawn, ThingWithComps weapon, ThingWithComps currentWeapon, bool isForcedUpgrade = false, List<ThingWithComps> inventoryWeapons = null, List<string> ideologyRejectedWeapons = null, JobGiverMapComponent mapComp = null)
        {
            ...
            try
            {
                ...
                if (searchSet != null)
                {
                    foreach (Thing thing in searchSet)
                    {
                        ...
                        bool shouldConsider = ShouldConsiderWeapon(pawn, weapon, pawn.equipment?.Primary, isForcedUpgrade, pawnInventoryWeapons, context.IdeologyRejectedWeapons, mapComp);
        ...
        public bool IsValidSize(Pawn pawn, ThingWithComps weapon)
        {
            ...
            // Race-specific adult check - supports HAR races with AdultMinAge = 0
