...
namespace AutoArm.Caching
{
    ...
    public static class PawnValidationCache
    {
        ...
        /// <summary>
        /// Event-driven removal when pawn dies/destroyed (complete cleanup)
        /// </summary>
        public static void RemovePawn(Pawn pawn)
        {
            ...
            RemoveFromLordCache(pawn);
            pawnsInRestrictedLords.Remove(pawn);
        }
        ...
        {
            // Early exit if all caches empty
            if (_cache.Count == 0 && _lastValidationTick.Count == 0 &&
                _lastInvalidationLogTick.Count == 0 && pawnLords.Count == 0 &&
                pawnsInRestrictedLords.Count == 0)
                return;
    ...
    public static class PawnValidationCachePatches
    {
        ...
        public static class Pawn_Destroy_Cache_Patch
        {
            ...
            public static void Prefix(Pawn __instance)
            {
                ...
                // Central cleanup handles all pawn-keyed caches
