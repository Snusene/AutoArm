...
namespace AutoArm.Logging
{
    ...
    internal static class AutoArmLogger
    {
        ...
        /// <summary>
        /// Weapon label
        /// Example: "legendary assault rifle", "normal knife"
        /// </summary>
        ...
        /// <summary>
        /// ThingDef label
        /// Example: "assault rifle", "charge lance"
        /// </summary>
        ...
        /// <summary>
        /// Format boolean for display: True â†’ true, False â†’ false
        /// Provides consistent lowercase boolean formatting for logs
        /// </summary>
        ...
        /// <summary>
        /// Pawn possessive
        /// Example: "Protein" â†’ "Protein's", "Chris" â†’ "Chris'"
        /// </summary>
